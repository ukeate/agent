...
class SecurityEnhancedService {
  ...
  async updateMcpToolWhitelist(whitelist: {
    ...
    const response = await apiClient.post(
      `${this.baseUrl}/mcp-tools/whitelist`,
      whitelist
    )
    return response.data
  }
  ...
  async updateMcpToolPermissions(permissions: {
    ...
    const response = await apiClient.put(
      `${this.baseUrl}/mcp-tools/permissions`,
      permissions
    )
    return response.data
  }
  ...
  async getSecurityPolicies(params?: {
    ...
    const response = await apiClient.get(`${this.distributedUrl}/policies`, {
      params,
    })
    return response.data
  }
  ...
  async encryptCommunication(data: {
    ...
    const response = await apiClient.post(
      `${this.distributedUrl}/communication/encrypt`,
      data
    )
    return response.data
  }
  ...
  async revokeAgentAccess(request: {
    ...
    const response = await apiClient.post(
      `${this.distributedUrl}/revoke-access`,
      request
    )
    return response.data
  }
  ...
  async validateSecurityPolicy(policy: any): Promise<{
    ...
    const response = await apiClient.post(
      `${this.distributedUrl}/policies/validate`,
      policy
    )
    return response.data
  }
