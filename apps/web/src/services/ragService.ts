...
// 导出枚举类型
export type QueryIntentType = 'factual' | 'procedural' | 'code' | 'creative' | 'exploratory';
export type ExpansionStrategyType = 'synonym' | 'semantic' | 'contextual' | 'decomposition' | 'multilingual';
