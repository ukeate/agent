...
class MemoryManagementService {
  ...
  async associateMemories(
    ...
    const response = await apiClient.post(`${this.baseUrl}/${memoryId}/associate`, null, {
      params: {
  ...
  async getRelatedMemories(
    ...
    const response = await apiClient.get(`${this.baseUrl}/${memoryId}/related`, {
      params: { depth, limit }
    });
    return response.data;
  }
  ...
  async consolidateSessionMemories(sessionId: string): Promise<{ message: string }> {
    const response = await apiClient.post(`${this.baseUrl}/consolidate/${sessionId}`);
    return response.data;
  }
