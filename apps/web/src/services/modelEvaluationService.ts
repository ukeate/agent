...
class ModelEvaluationService {
  ...
  async getEvaluationStatus(evaluationId: string): Promise<EvaluationResult> {
    const response = await apiClient.get(
      `${this.baseUrl}/evaluation/${evaluationId}`
    )
    return response.data
  }
  ...
  async getEvaluationResults(evaluationId: string): Promise<EvaluationResult> {
    const response = await apiClient.get(
      `${this.baseUrl}/evaluation/${evaluationId}/results`
    )
    return response.data
  }
  ...
  async cancelEvaluation(
    ...
    const response = await apiClient.post(
      `${this.baseUrl}/evaluation/${evaluationId}/cancel`
    )
    return response.data
  }
  ...
  async getBenchmarkResults(benchmarkId: string): Promise<BenchmarkResult> {
    const response = await apiClient.get(
      `${this.baseUrl}/benchmark/${benchmarkId}/results`
    )
    return response.data
  }

  async listAvailableBenchmarks(): Promise<
    Array<{
      name: string
      description: string
      tasks: string[]
  ...
  async getPerformanceMetrics(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/performance/${modelName}`,
      {
  ...
  async getPerformanceHistory(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/performance/${modelName}/history`,
      {
  ...
  async startPerformanceMonitoring(
    ...
    const response = await apiClient.post(
      `${this.baseUrl}/performance/${modelName}/monitor`,
      config || {}
    )
    return response.data
  }
  ...
  async stopPerformanceMonitoring(
    ...
    const response = await apiClient.delete(
      `${this.baseUrl}/performance/${modelName}/monitor/${monitorId}`
    )
    return response.data
  }
  ...
  async downloadReport(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/report/${reportId}/download`,
      {
        params: { format },
        responseType: 'blob',
      }
  ...
  subscribeToEvaluationUpdates(
    ...
    const wsUrl = buildWsUrl(
      `${this.baseUrl}/evaluation/${evaluationId}/stream`
    )
