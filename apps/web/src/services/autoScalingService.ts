...
class AutoScalingService {
  ...
  // 创建扩量规则
  async createScalingRule(
    request: CreateScalingRuleRequest
  ): Promise<{ success: boolean; rule: ScalingRule }> {
    try {
  ...
  async startAutoScaling(
    ruleId: string
  ): Promise<{ success: boolean; message: string; rule_id: string }> {
    try {
  ...
  async listRules(
    experimentId?: string
  ): Promise<{ success: boolean; rules: ScalingRule[]; total: number }> {
    try {
  ...
  async getScalingHistory(
    ...
    success: boolean
    history: ScalingHistory | null
    message?: string
  }> {
    try {
      const response = await apiClient.get(
        `${this.baseUrl}/history/${experimentId}`
      )
      return response.data
    } catch (error) {
  ...
  async getRecommendations(
    experimentId: string
  ): Promise<{ success: boolean; recommendations: ScalingRecommendation[] }> {
    try {
      const response = await apiClient.get(
        `${this.baseUrl}/recommendations/${experimentId}`
      )
      return response.data
    } catch (error) {
  ...
  // 创建安全扩量模板
  async createSafeTemplate(
    experimentId: string
  ): Promise<{ success: boolean; rule: Partial<ScalingRule> }> {
    try {
      const response = await apiClient.post(
        `${this.baseUrl}/templates/safe?experiment_id=${experimentId}`
      )
      return response.data
    } catch (error) {
  ...
  // 创建激进扩量模板
  async createAggressiveTemplate(
    experimentId: string
  ): Promise<{ success: boolean; rule: Partial<ScalingRule> }> {
    try {
      const response = await apiClient.post(
        `${this.baseUrl}/templates/aggressive?experiment_id=${experimentId}`
      )
      return response.data
    } catch (error) {
  ...
  // 获取扩量模式列表
  async listScalingModes(): Promise<{
    success: boolean
    modes: ScalingModeInfo[]
  }> {
    try {
