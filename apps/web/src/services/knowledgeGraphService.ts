...
class KnowledgeGraphService {
  ...
  async getRelation(relationId: string): Promise<Relation> {
    const response = await apiClient.get(
      `${this.baseUrl}/relations/${relationId}`
    )
    return response.data
  }
  ...
  async getEntityRelations(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/entities/${entityId}/relations`,
      { params }
    )
  ...
  async getQueryTemplates(category?: string): Promise<QueryTemplate[]> {
    ...
    const response = await apiClient.get(`${this.baseUrl}/query/templates`, {
      params,
    })
  ...
  async saveQueryTemplate(
    template: Omit<QueryTemplate, 'id' | 'created_at' | 'usage_count'>
  ): Promise<QueryTemplate> {
    const response = await apiClient.post(
      `${this.baseUrl}/query/templates`,
      template
    )
    return response.data
  }
  ...
  > {
    ...
    const response = await apiClient.get(`${this.baseUrl}/paths/all`, {
      params,
    })
  ...
  async getSubgraph(
    ...
    const response = await apiClient.get(
      `${this.baseUrl}/subgraph/${entityId}`,
      { params }
    )
    return response.data
  }
  ...
  async getQualityIssues(): Promise<
    Array<{
      issue_id: string
      issue_type: string
      description: string
  ...
  async initializeSchema(): Promise<{
    ...
    const response = await apiClient.post(
      `${this.baseUrl}/admin/schema/initialize`
    )
    return response.data
  }
  ...
  async batchUpsert(entities: CreateEntityRequest[]): Promise<{
    ...
    const response = await apiClient.post(`${this.baseUrl}/batch-upsert`, {
      entities,
    })
    return response.data
  }
  ...
  async batchReasoning(
    ...
    const response = await apiClient.post('/kg-reasoning/batch', {
      queries: requests,
    })
    return response.data
  }
  ...
  async conflictResolution(request: {
    ...
    const response = await apiClient.post(
      '/graphrag/fusion/conflict-resolution',
      request
    )
    return response.data
  }
  ...
  async getPerformanceComparison(params?: {
    ...
    const response = await apiClient.get('/graphrag/performance/comparison', {
      params,
    })
    return response.data
  }
  ...
  async runPerformanceBenchmark(request: {
    ...
    const response = await apiClient.post(
      '/graphrag/performance/benchmark',
      request
    )
    return response.data
  }
  ...
  async applyMigration(migrationId: string): Promise<MigrationRecord> {
    const response = await apiClient.post(
      `${this.baseUrl}/migrations/${migrationId}/apply`
    )
    return response.data
  }
  ...
  async applyAllMigrations(): Promise<MigrationRecord[]> {
    const response = await apiClient.post(
      `${this.baseUrl}/migrations/apply-all`
    )
    return response.data.records || []
  }
  ...
  async rollbackMigration(migrationId: string): Promise<MigrationRecord> {
    const response = await apiClient.post(
      `${this.baseUrl}/migrations/${migrationId}/rollback`
    )
    return response.data
  }
}
