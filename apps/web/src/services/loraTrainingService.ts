...
class LoRATrainingService {
  ...
  async getTrainingJobs(filters?: {
    ...
    const response = await apiClient.get(`${this.baseUrl}/jobs`, { params: filters });
    return response.data;
  }
   ...
   * 启动训练任务
   */
  async startTraining(jobId: string): Promise<{ success: boolean; message: string }> {
   ...
   * 停止训练任务
   */
  async stopTraining(jobId: string): Promise<{ success: boolean; message: string }> {
   ...
   * 暂停训练任务
   */
  async pauseTraining(jobId: string): Promise<{ success: boolean; message: string }> {
   ...
   * 恢复训练任务
   */
  async resumeTraining(jobId: string): Promise<{ success: boolean; message: string }> {
  ...
  async getTrainingProgress(jobId: string): Promise<TrainingProgress> {
    const response = await apiClient.get(`${this.baseUrl}/jobs/${jobId}/progress`);
    return response.data;
  }
  ...
  async getTrainingMetrics(
    ...
    const response = await apiClient.get(`${this.baseUrl}/jobs/${jobId}/metrics`, { 
      params: options 
    });
    return response.data;
  }
  ...
  async getModelInfo(jobId: string): Promise<ModelInfo> {
    const response = await apiClient.get(`${this.baseUrl}/jobs/${jobId}/model-info`);
    return response.data;
  }
  ...
  async getLoRALayers(jobId: string): Promise<LoRALayer[]> {
    const response = await apiClient.get(`${this.baseUrl}/jobs/${jobId}/lora-layers`);
    return response.data;
  }
  ...
  async getCheckpoints(jobId: string): Promise<CheckpointInfo[]> {
    const response = await apiClient.get(`${this.baseUrl}/jobs/${jobId}/checkpoints`);
    return response.data;
  }
  ...
  async saveCheckpoint(
    ...
    const response = await apiClient.post(`${this.baseUrl}/jobs/${jobId}/checkpoints`, {
      name: checkpointName
    });
    return response.data;
  }
  ...
  async updateLoRAConfig(
    ...
    const response = await apiClient.patch(`${this.baseUrl}/jobs/${jobId}/lora-config`, config);
    return response.data;
  }
  ...
  async updateTrainingConfig(
    ...
    const response = await apiClient.patch(`${this.baseUrl}/jobs/${jobId}/training-config`, config);
    return response.data;
  }
  ...
  async exportLoRAAdapter(
    ...
    const response = await apiClient.post(`${this.baseUrl}/jobs/${jobId}/export`, { format });
    return response.data;
  }
  ...
  async mergeLoRAWeights(
    ...
    const response = await apiClient.post(`${this.baseUrl}/jobs/${jobId}/merge`, options);
    return response.data;
  }
  ...
  async testInference(
    ...
    const response = await apiClient.post(`${this.baseUrl}/jobs/${jobId}/inference`, {
      input_text,
      generation_config
    });
    return response.data;
