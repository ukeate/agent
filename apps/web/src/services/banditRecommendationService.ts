...
class BanditRecommendationService {
  ...
  async initialize(
    ...
    const response = await apiClient.post(
      `${this.baseUrl}/initialize?${params}`
    )
  ...
  async updateUserContext(
    ...
    const response = await apiClient.put(
      `${this.baseUrl}/user/${userId}/context`,
      context
    )
    return response.data
  }
  ...
  async updateItemFeatures(
    ...
    const response = await apiClient.put(
      `${this.baseUrl}/item/${itemId}/features`,
      features
    )
    return response.data
  }
  ...
  async endExperiment(experimentId: string): Promise<{
    ...
    const response = await apiClient.post(
      `${this.baseUrl}/experiments/${experimentId}/end`
    )
    return response.data
  }
