    ...
    <div style={{ padding: 24 }}>
      <Space direction="vertical" style={{ width: '100%' }} size="large">
        ...
        <Row gutter={16}>
          <Col span={6}>
            <Card>
              <Statistic title="总体质量" value={metrics?.overall_score ?? 0} />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
              <Statistic title="完整性" value={metrics?.completeness ?? 0} />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
              <Statistic title="准确性" value={metrics?.accuracy ?? 0} />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
              <Statistic title="一致性" value={metrics?.consistency ?? 0} />
            </Card>
          </Col>
        </Row>
