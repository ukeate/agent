  ...
  const loadData = async () => {
    ...
    try {
      ...
      setResourceStats({
        ...
        networkConnections: isNumber(system.network_connections)
  ...
  const performanceMetrics = [
    {
      ...
      unit: 'QPS',
      ...(buildChange(
        metricSnapshot?.throughput ?? null,
        prevSnapshot?.throughput ?? null
      ) || {}),
    },
    {
      name: '平均响应时间',
      ...
      unit: 'ms',
      ...(buildChange(
        metricSnapshot?.avgTime ?? null,
        prevSnapshot?.avgTime ?? null
      ) || {}),
    },
    {
      name: '峰值响应时间',
      ...
      unit: 'ms',
      ...(buildChange(
        metricSnapshot?.maxTime ?? null,
        prevSnapshot?.maxTime ?? null
      ) || {}),
    },
    {
      name: '错误率',
      ...
      unit: '%',
      ...(buildChange(
        metricSnapshot?.errorRate ?? null,
        prevSnapshot?.errorRate ?? null
      ) || {}),
    },
  ]
          ...
          <Card title="性能建议" size="small">
            <Space direction="vertical" style={{ width: '100%' }}>
              {recommendations.length === 0 && (
                <Alert message="暂无性能建议" type="info" showIcon />
              )}
