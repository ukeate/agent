...
const QLearningPerformanceOptimizationPage: React.FC = () => {
  ...
  const [optimizationTrials, setOptimizationTrials] = useState<
    OptimizationTrial[]
  >([])
  ...
  const optimizationColumns = [
    ...
    },
    {
      title: '学习率',
      key: 'learning_rate',
      render: (record: OptimizationTrial) =>
        record.parameters.learning_rate?.toFixed(6),
    },
    {
      title: '批次大小',
      key: 'batch_size',
    ...
    },
    {
      ...
      key: 'epsilon_decay',
      render: (record: OptimizationTrial) =>
        record.parameters.epsilon_decay?.toFixed(4),
    },
    {
      title: '目标值',
        ...
        <Row gutter={[16, 16]}>
          <Col span={6}>
            <Card>
              ...
              />
              <Progress
                percent={Math.min(metrics.training_fps / 5, 100)}
                showInfo={false}
              />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
              ...
              />
              <Progress
                percent={Math.min(metrics.inference_fps / 20, 100)}
                showInfo={false}
              />
            </Card>
          </Col>
          <Col span={6}>
            <Card>
              <Statistic
                ...
                prefix={<GpuOutlined />}
                valueStyle={{
                  color: metrics.gpu_utilization > 80 ? '#3f8600' : '#faad14',
                }}
              />
          ...
          <Col span={6}>
            <Card>
              <Statistic
                ...
                valueStyle={{
                  color: metrics.memory_usage > 30 ? '#cf1322' : '#3f8600',
                }}
              />
              <Progress
                percent={Math.min(metrics.memory_usage * 2, 100)}
                showInfo={false}
              />
            </Card>
          </Col>
                      ...
                      <Card
                        ...
                        extra={
                          <Space>
                            ...
                            <Button
                              type="primary"
                              onClick={() => form.setFieldsValue(config)}
                            >
                              应用配置
                            </Button>
                          </Space>
                              ...
                              <Form layout="vertical" size="small">
                                <Form.Item label="采样策略">
                                  ...
                                  >
                                    ...
                                    <Option value="recency_weighted">
                                      近期加权
                                    </Option>
                                    <Option value="curiosity_driven">
                                      好奇心驱动
                                    </Option>
                                  </Select>
                                </Form.Item>
                            ...
                            >
                              <Form layout="vertical" size="small">
                                <Form.Item label="分布式策略">
                                  ...
                                  >
                                    <Option value="data_parallel">
                                      数据并行
                                    </Option>
                                    <Option value="model_parallel">
                                      模型并行
                                    </Option>
                                    <Option value="parameter_server">
                                      参数服务器
                                    </Option>
                                ...
                                <Form.Item label="梯度压缩">
                                  <Switch
                                    checked={
                                      config.distributed.compression_enabled
                                    }
                                    onChange={checked =>
                                      setConfig(prev => ({
                                        ...prev,
