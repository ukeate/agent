  ...
  const loadSecurityAlerts = async () => {
    try {
      ...
      const mapped = list.map((alert: any) => {
        ...
        const type: SecurityEvent['type'] = alertType.includes('unauthorized')
          ? 'access_denied'
  ...
  const eventColumns = [
    ...
    },
    {
      ...
      render: (type: keyof typeof eventTypeColors) => (
        <Tag color={eventTypeColors[type]}>{eventTypeTexts[type]}</Tag>
      ),
    },
    {
      title: '严重程度',
    ...
    <div className="p-6">
      <div className="mb-6">
        <div className="flex justify-between items-center mb-4">
          ...
          <Space>
            <Button icon={<AuditOutlined />}>生成安全报告</Button>
            <Button icon={<SettingOutlined />}>安全设置</Button>
          </Space>
        </div>
          ...
          <Col span={6}>
            <Card>
              <Statistic
                ...
                suffix="%"
                valueStyle={{
                  color: securityScore >= 80 ? '#3f8600' : '#cf1322',
                }}
          ...
          <Col span={6}>
            <Card>
              <Statistic
                ...
                valueStyle={{
                  color: suspendedUsers > 0 ? '#cf1322' : '#3f8600',
                }}
                prefix={<LockOutlined />}
              />
            </Card>
          ...
          <Col span={6}>
            <Card>
              <Statistic
                ...
                valueStyle={{
                  color: criticalEvents > 0 ? '#cf1322' : '#3f8600',
                }}
