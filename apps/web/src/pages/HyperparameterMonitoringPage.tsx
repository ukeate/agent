...
type ResourceStats = { current_trials: number; max_concurrent: number; resource_usage?: Record<string, number>; active_trials?: string[] };
type ActiveExperiment = { id: string; status?: string; algorithm?: string; objective?: string };
