...
const HyperparameterExperimentsPage: React.FC = () => {
  ...
  const startExperiment = async (experimentId: string) => {
    try {
      const response = await apiFetch(
        `${API_BASE}/experiments/${experimentId}/start`,
        {
          method: 'POST',
        }
      )
  ...
  const stopExperiment = async (experimentId: string) => {
    try {
      const response = await apiFetch(
        `${API_BASE}/experiments/${experimentId}/stop`,
        {
          method: 'POST',
        }
      )
                ...
                <div className="flex justify-between items-start">
                  <div className="flex-1">
                    <div className="flex items-center space-x-3 mb-2">
                      ...
                      <Badge className="bg-purple-100 text-purple-800">
                        {algorithmNames[
                          experiment.algorithm as keyof typeof algorithmNames
                  ...
                  <div className="flex space-x-2 ml-4">
                    ...
                    <Button
                      ...
                      variant="outline"
                      onClick={() =>
                        window.open(`/hyperparameter-optimization`, '_blank')
                      }
                    >
                      详情
                    </Button>
