...
const MonitoringPerformanceOptimizationPage: React.FC = () => {
  ...
  const [optimizationDrawerVisible, setOptimizationDrawerVisible] =
    useState(false)
      ...
      render: (record: PerformanceAlert) => (
        <div>
          ...
          >
            <Badge
              status={
                record.severity === 'fatal' || record.severity === 'critical'
                  ? 'error'
                  : record.severity === 'warning'
                    ? 'warning'
                    : 'processing'
          ...
          <div style={{ marginBottom: '2px' }}>
            <Text
              style={{
                fontSize: '11px',
                color:
                  record.currentValue > record.threshold
                    ? '#ff4d4f'
                    : '#52c41a',
              }}
            >
  ...
  return (
    <div style={{ padding: '24px', background: '#f5f5f5', minHeight: '100vh' }}>
          ...
          <Card>
            <Statistic
              ...
              valueStyle={{
                color: getHealthColor(
                  performanceMetrics.systemHealth.overallScore
                ),
              }}
            ...
            <div style={{ marginTop: '8px' }}>
              <Text type="secondary" style={{ fontSize: '12px' }}>
                状态:{' '}
                {getHealthStatus(performanceMetrics.systemHealth.overallScore)}
              </Text>
            </div>
          </Card>
        </Col>
        ...
        <Col xs={12} sm={6}>
          <Card>
            <Statistic
              ...
              valueStyle={{
                color:
                  performanceMetrics.messageLatency.average > 200
                    ? '#ff4d4f'
                    : '#52c41a',
              }}
          ...
          <Card>
            ...
            <div style={{ marginTop: '8px' }}>
              <Progress
                percent={Math.min(
                  100,
                  performanceMetrics.errorRates.total * 10
                )}
                size="small"
                showInfo={false}
                status={
      ...
      <Card>
        ...
        >
          ...
          <Space>
            ...
            <Button
              icon={<TrophyOutlined />}
              onClick={() => setOptimizationDrawerVisible(true)}
            >
              优化建议
            </Button>
            <Button
                ...
                <Card title="延迟分析" size="small">
                  <Row gutter={[16, 8]}>
                    <Col span={12}>
                      <Statistic
                        title="P50"
                        value={performanceMetrics.messageLatency.p50}
                        suffix="ms"
                      />
                    </Col>
                    <Col span={12}>
                      <Statistic
                        title="P95"
                        value={performanceMetrics.messageLatency.p95}
                        suffix="ms"
                      />
                    </Col>
                    <Col span={12}>
                      <Statistic
                        title="P99"
                        value={performanceMetrics.messageLatency.p99}
                        suffix="ms"
                      />
                    </Col>
                    <Col span={12}>
                ...
                <Card title="系统资源使用" size="small">
                  <div style={{ marginBottom: '12px' }}>
                    ...
                    >
                      ...
                      <Text style={{ fontSize: '12px' }}>
                        {performanceMetrics.resourceUsage.cpu.toFixed(1)}%
                      </Text>
                    </div>
                    <Progress
                  ...
                  <div style={{ marginBottom: '12px' }}>
                    ...
                    >
                      ...
                      <Text style={{ fontSize: '12px' }}>
                        {performanceMetrics.resourceUsage.memory.toFixed(1)}%
                      </Text>
                    </div>
                    <Progress
                      percent={performanceMetrics.resourceUsage.memory}
                      size="small"
                    />
                  </div>
                  ...
                  <div style={{ marginBottom: '12px' }}>
                    ...
                    >
                      ...
                      <Text style={{ fontSize: '12px' }}>
                        {performanceMetrics.resourceUsage.network.toFixed(1)}%
                      </Text>
                    </div>
                    <Progress
                      percent={performanceMetrics.resourceUsage.network}
                      size="small"
                    />
                  </div>
                  ...
                  <div>
                    ...
                    >
                      ...
                      <Text style={{ fontSize: '12px' }}>
                        {performanceMetrics.resourceUsage.disk.toFixed(1)}%
                      </Text>
                    </div>
                    <Progress
                      percent={performanceMetrics.resourceUsage.disk}
                      size="small"
                    />
                  </div>
                </Card>
            ...
            {performanceAlerts.filter(a => a.status === 'active').length >
              ...
              <>
                ...
                <Table
                  ...
                  dataSource={performanceAlerts.filter(
                    a => a.status === 'active'
                  )}
                  rowKey="id"
                  size="small"
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <div
                          style={{
                            ...
                            fontWeight: 'bold',
                            color: getHealthColor(
                              performanceMetrics.systemHealth.availability
                            ),
                          }}
                        >
                          {performanceMetrics.systemHealth.availability.toFixed(
                            1
                          )}
                          %
                        </div>
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <div
                          style={{
                            ...
                            fontWeight: 'bold',
                            color: getHealthColor(
                              performanceMetrics.systemHealth.reliability
                            ),
                          }}
                        >
                          {performanceMetrics.systemHealth.reliability.toFixed(
                            1
                          )}
                          %
                        </div>
                      ...
                      <div style={{ textAlign: 'center' }}>
                        <div
                          style={{
                            ...
                            fontWeight: 'bold',
                            color: getHealthColor(
                              performanceMetrics.systemHealth.performance
                            ),
                          }}
                        >
                          {performanceMetrics.systemHealth.performance.toFixed(
                            1
                          )}
                          %
                        </div>
      ...
      >
        ...
        <List
          dataSource={optimizationSuggestions.sort(
              ...
              <List.Item.Meta
                ...
                description={
                  <div>
                    ...
                    <div style={{ marginTop: '8px' }}>
                      <Tag color="green">
                        预期收益: {item.metrics.expectedImprovement}
                      </Tag>
                      <Tag color="orange">
                        预估时间: {item.implementation.estimatedTime}
                      </Tag>
                    </div>
                  </div>
                }
