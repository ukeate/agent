    ...
    <div className="p-6 space-y-6">
      ...
      <div className="flex items-center justify-between">
        ...
        <div className="flex items-center space-x-3">
          {lastSaved && (
            <span className="text-sm text-gray-500">最后保存: {lastSaved}</span>
          )}
              ...
              <ConfigSection title="异常检测配置">
                ...
                >
                  <Switch
                    ...
                    onChange={checked =>
                      updateConfig('anomaly_detection', 'enabled', checked)
                    }
                  />
                </ConfigItem>
              ...
              <ConfigSection title="性能优化配置">
                ...
                >
                  <Switch
                    ...
                    onChange={checked =>
                      updateConfig('performance', 'cache_enabled', checked)
                    }
                  />
                </ConfigItem>
              ...
              <ConfigSection title="数据存储配置">
                ...
                >
                  <Switch
                    ...
                    onChange={checked =>
                      updateConfig('storage', 'partitioning_enabled', checked)
                    }
                  />
                </ConfigItem>

                <ConfigItem label="分区间隔" description="数据表分区的时间间隔">
                  <select
                    className="px-3 py-1 border border-gray-300 rounded text-sm"
                ...
                <ConfigItem label="压缩算法" description="数据压缩算法选择">
                  <select
                    className="px-3 py-1 border border-gray-300 rounded text-sm"
                ...
                >
                  <Switch
                    ...
                    onChange={checked =>
                      updateConfig('storage', 'index_optimization', checked)
                    }
                  />
                </ConfigItem>
                ...
                >
                  <Switch
                    ...
                    onChange={checked =>
                      updateConfig('storage', 'cleanup_enabled', checked)
                    }
                  />
                </ConfigItem>
              </ConfigSection>
          ...
          {tabs.map(tab => (
            <div key={tab.id} className="p-3 bg-gray-50 rounded-md">
              ...
              <div className="text-xs text-gray-600">
                {Object.keys(config[tab.id as keyof SystemConfig]).length}{' '}
                项配置
              </div>
            </div>
          ))}
