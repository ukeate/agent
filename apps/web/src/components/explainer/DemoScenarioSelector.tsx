  ...
  const scenarios: DemoScenario[] = [
    {
      ...
      category: 'finance',
      description:
        '分析个人贷款申请的风险评估和决策过程，展示信用评分、收入验证、风险因子等关键要素。',
      ...
      datasets: [
        {
          name: '信用评分数据',
          description: '央行征信系统数据',
          records: 10000,
        },
        {
          name: '收入验证记录',
          description: '银行流水和工资单',
          records: 5000,
        },
        {
          name: '历史违约记录',
          description: '过往贷款违约统计',
          records: 2000,
        },
      ],
      learningObjectives: [
    ...
    },
    {
      ...
      category: 'healthcare',
      description:
        '基于症状、检查结果和病史的疾病诊断建议，重点展示医疗AI的决策透明度和可信度。',
      complexity: 'advanced',
      duration: '25-30分钟',
    ...
    },
    {
      ...
      category: 'hr',
      description:
        '综合员工工作表现、技能发展和团队协作，提供客观的绩效评估和发展建议。',
      complexity: 'intermediate',
      duration: '20-25分钟',
    ...
    },
    {
      ...
      category: 'security',
      description:
        '实时监控交易行为，识别可疑模式并评估欺诈风险，重点展示安全AI的决策逻辑。',
      complexity: 'advanced',
      duration: '20-25分钟',
      ...
      datasets: [
        {
          name: '交易行为数据',
          description: '历史交易模式分析',
          records: 500000,
        },
        {
          name: '设备指纹库',
          description: '用户设备特征记录',
          records: 100000,
        },
    ...
    },
    {
      ...
      category: 'finance',
      description:
        '分析供应商财务状况、地缘政治风险和市场波动，预测供应链中断风险。',
      complexity: 'advanced',
      duration: '30-35分钟',
              ...
              <CardHeader className="pb-3">
                <div className="flex items-start justify-between">
                  <div className="flex items-center space-x-3">
                    <div
                      className={`p-2 rounded-lg ${getCategoryColor(scenario.category)}`}
                    >
                      {scenario.icon}
                    </div>
                    <div>
                      ...
                      <div className="flex items-center space-x-2 mt-1">
                        <Badge
                          className={getComplexityColor(scenario.complexity)}
                          variant="outline"
                        >
                  ...
                  <Button
                    onClick={() =>
                      setShowDetails(isExpanded ? null : scenario.id)
                    }
                    variant="ghost"
                    size="sm"
                  >
              ...
              <CardContent className="space-y-4">
                  ...
                  <div className="space-y-2 text-xs">
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {scenario.previewData.decision_outcome}
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>置信度:</span>
                      <span className="font-medium">
                        {(scenario.previewData.confidence * 100).toFixed(0)}%
                      </span>
                    </div>
                    <div className="flex justify-between">
                      <span>风险等级:</span>
                      <span
                        className={`font-medium ${getRiskColor(scenario.previewData.risk_level)}`}
                      >
                        {scenario.previewData.risk_level === 'low'
                          ? '低'
                          : scenario.previewData.risk_level === 'medium'
                            ? '中'
                            : '高'}
                      </span>
                    </div>
                ...
                <div className="flex justify-between items-center pt-3 border-t">
                  <div className="flex items-center space-x-2">
                    <TrendingUp
                      className={`h-4 w-4 ${getRiskColor(scenario.previewData.risk_level)}`}
                    />
