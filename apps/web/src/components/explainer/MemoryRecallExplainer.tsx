...
const MemoryRecallExplainer: React.FC<MemoryRecallExplainerProps> = ({
  ...
  const [selectedView, setSelectedView] = useState<
    'overview' | 'process' | 'memories' | 'analysis'
  >('overview')
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-purple-600">
                {formatDuration(
                  recallProcess.performance_metrics.total_duration
                )}
              </div>
            ...
            <div className="text-center">
              <div className="text-2xl font-bold text-orange-600">
                {recallProcess.recalled_memories.length > 0
                  ? (
                      (recallProcess.recalled_memories.reduce(
                        (sum, m) => sum + m.relevance_score,
                        0
                      ) /
                        recallProcess.recalled_memories.length) *
                      100
                ...
                <div className="space-y-3">
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Progress
                        value={
                          recallProcess.search_strategy.vector_weight * 100
                        }
                        className="w-20 h-2"
                      />
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Progress
                        value={
                          recallProcess.search_strategy.temporal_weight * 100
                        }
                        className="w-20 h-2"
                      />
                      <span className="font-medium">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Progress
                        value={
                          recallProcess.search_strategy.entity_weight * 100
                        }
                        className="w-20 h-2"
                      />
                      <span className="font-medium">
                  ...
                  <div className="flex items-center justify-between">
                    ...
                    <div className="flex items-center space-x-2">
                      <Progress
                        value={
                          recallProcess.search_strategy.importance_weight * 100
                        }
                        className="w-20 h-2"
                      />
                      <span className="font-medium">
              ...
              <CardContent>
                <div className="space-y-3">
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formatDuration(
                        recallProcess.performance_metrics.vector_search_time
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formatDuration(
                        recallProcess.performance_metrics
                  ...
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formatDuration(
                        recallProcess.performance_metrics.entity_matching_time
                      )}
                    </span>
                  </div>
                  <div className="flex justify-between">
                    ...
                    <span className="font-medium">
                      {formatDuration(
                        recallProcess.performance_metrics.ranking_time
                      )}
                    </span>
                  </div>
                  {recallProcess.performance_metrics.cache_hit_rate && (
                    <div className="flex justify-between">
                      ...
                      <span className="font-medium">
                        {(
                          recallProcess.performance_metrics.cache_hit_rate * 100
                        ).toFixed(1)}
                        %
                      </span>
                    </div>
            ...
            <CardContent>
              <div className="space-y-4">
                {recallProcess.processing_steps.map((step, index) => {
                  const efficiency =
                    step.memories_retained / step.memories_processed
                  const isLast =
                    index === recallProcess.processing_steps.length - 1
                          ...
                          <div className="flex items-center space-x-3">
                            <div
                              className={`w-8 h-8 rounded-full border-2 flex items-center justify-center ${
                                step.step_type === 'vectorization'
                                  ? 'bg-blue-100 text-blue-600 border-blue-200'
                                  : step.step_type === 'search'
                                    ? 'bg-green-100 text-green-600 border-green-200'
                                    : step.step_type === 'temporal'
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-3 gap-4 text-sm">
                          <div>
                            ...
                            <div className="font-medium">
                              {step.memories_processed}
                            </div>
                          </div>
                          <div>
                            <span className="text-gray-600">保留记忆数:</span>
                            <div className="font-medium">
                              {step.memories_retained}
                            </div>
                          </div>
                          <div>
                    ...
                    return (
                      ...
                      >
                        <div
                          ...
                          onClick={() =>
                            setExpandedMemory(
                              isExpanded ? null : memory.memory_id
                            )
                          }
                        >
                          <div className="flex items-center justify-between mb-2">
                            ...
                            <div className="text-right">
                              <div
                                className={`text-lg font-semibold ${getRelevanceColor(memory.relevance_score)}`}
                              >
                          ...
                          <div className="mt-4 space-y-4">
                            ...
                            {memory.full_content &&
                              memory.full_content !==
                                ...
                                <Button
                                  onClick={() =>
                                    toggleFullContent(memory.memory_id)
                                  }
                                  variant="outline"
                                  size="sm"
                                >
                            ...
                            <div className="grid grid-cols-2 md:grid-cols-4 gap-4 text-sm">
                              ...
                              {memory.embedding_similarity && (
                                <div>
                                  ...
                                  <div className="font-medium">
                                    {(
                                      memory.embedding_similarity * 100
                                    ).toFixed(1)}
                                    %
                                  </div>
                                </div>
                              ...
                              {memory.temporal_boost && (
                                <div>
                                  ...
                                  <div className="font-medium">
                                    +{(memory.temporal_boost * 100).toFixed(1)}%
                                  </div>
                                </div>
                              )}
                              <div>
                            ...
                            <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                              ...
                              {memory.entity_matches &&
                                memory.entity_matches.length > 0 && (
                                  <div>
                                    <h5 className="font-medium mb-2 flex items-center">
              ...
              <CardContent>
                <div className="space-y-3">
                  {Object.entries(
                    ...
                    const percentage =
                      (count / recallProcess.recalled_memories.length) * 100
                    return (
                      <div key={type}>
                  ...
                  {[
                    ...
                    const count = recallProcess.recalled_memories.filter(m =>
                      min === 0.8
                        ...
                        : min === 0.6
                          ? m.relevance_score >= min && m.relevance_score < 0.8
              ...
              <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
                ...
                <div className="text-center p-4 bg-purple-50 rounded-lg">
                  <div className="text-2xl font-bold text-purple-600">
                    {
                      new Set(
                        recallProcess.recalled_memories.flatMap(m => m.tags)
                      ).size
                    }
                  </div>
