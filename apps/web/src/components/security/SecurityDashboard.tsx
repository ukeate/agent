      ...
      <Card className="p-6">
        ...
        <div className="flex space-x-6">
          <div className="flex items-center">
            ...
            <span className="text-sm">高风险: {stats?.high_risk_events || 0}</span>
          </div>
          <div className="flex items-center">
            <div className="w-4 h-4 bg-yellow-500 rounded mr-2"></div>
            <span className="text-sm">中风险: {stats?.medium_risk_events || 0}</span>
          </div>
          <div className="flex items-center">
            <div className="w-4 h-4 bg-blue-500 rounded mr-2"></div>
            <span className="text-sm">低风险: {stats?.low_risk_events || 0}</span>
          </div>
        </div>
      </Card>
                ...
                <div className="flex items-center space-x-3">
                  ...
                  <div>
                    ...
                    <div className="text-sm text-gray-500">
                      类型: {alert.alert_type} | 时间: {new Date(alert.timestamp).toLocaleString()}
                    </div>
                  </div>
                </div>
