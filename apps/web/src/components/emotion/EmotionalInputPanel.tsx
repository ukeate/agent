...
export const EmotionalInputPanel: React.FC<EmotionalInputPanelProps> = ({
  ...
  const updatePhysiologicalData = useCallback(
    (next: PhysiologicalData) => {
  ...
  return (
    <Card className={cn('w-full', className)}>
      ...
      <CardContent>
        <Tabs
          value={activeTab}
          onValueChange={value => setActiveTab(value as ModalityType)}
        >
            ...
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                {recordingState.blob && (
                  <Badge variant="outline">
                    已录制 {formatDuration(recordingState.duration)}
                  </Badge>
                )}
              </div>
              ...
              <div className="flex items-center gap-4">
                <Button
                  ...
                  variant={
                    recordingState.isRecording ? 'destructive' : 'default'
                  }
                  size="lg"
          ...
          <TabsContent value={ModalityType.VIDEO} className="space-y-4">
            <div className="space-y-4">
              <div className="flex items-center justify-between">
                ...
                {videoState.blob && (
                  <Badge variant="outline">
                    已录制 {formatDuration(videoState.duration)}
                  </Badge>
                )}
              </div>
                ...
                <div className="grid grid-cols-2 gap-4">
                  ...
                  {physiologicalData.skinConductance != null && (
                    <div className="p-3 bg-muted rounded-lg">
                      ...
                      <div className="text-2xl font-bold">
                        {physiologicalData.skinConductance.toFixed(2)}{' '}
                  ...
                  {physiologicalData.temperature != null && (
                    <div className="p-3 bg-muted rounded-lg">
                      ...
                      <div className="text-2xl font-bold">
                        {physiologicalData.temperature.toFixed(1)}{' '}
