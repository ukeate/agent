  ...
  const importColumns = [
    ...
    { title: '格式', dataIndex: 'format', key: 'format' },
    {
      ...
      render: (status: string) => (
        <Progress
          percent={
            status === 'completed' ? 100 : status === 'processing' ? 60 : 0
          }
  ...
  const exportColumns = [
    ...
    { title: '格式', dataIndex: 'format', key: 'format' },
    {
      ...
      render: (status: string) => (
        <Progress
          percent={
            status === 'completed' ? 100 : status === 'processing' ? 45 : 0
          }
          size="small"
        />
      ),
                    ...
                    <Space direction="vertical" style={{ width: '100%' }}>
                      <div>
                        ...
                        <Select
                          ...
                          style={{ width: '100%' }}
                        >
                          <Select.Option value="postgres1">
                            PostgreSQL-1
                          </Select.Option>
                          <Select.Option value="postgres2">
                            PostgreSQL-2
                          </Select.Option>
                        </Select>
                      </div>
