      ...
      >
        ...
        <Card title="推理配置" className="mb-4">
          <Row gutter={[24, 24]}>
            ...
            <Col span={12}>
              <Form.Item label="背景信息（可选）" name="context">
                <TextArea
                  rows={6}
          ...
          <Row gutter={[24, 16]}>
            ...
            <Col span={8}>
              <Form.Item label="最大推理步骤" name="max_steps">
              ...
              <Col span={8} key={key}>
                <Card size="small" className="h-full">
                  ...
                  <div className="space-y-2">
                    ...
                    <div>
                      <Text variant="warning" className="text-xs font-medium">
                        劣势:
                      </Text>
                      <ul className="text-xs text-gray-600 mt-1 ml-4">
                        {info.cons.map((con, i) => (
        ...
        {showAdvanced && (
          <Card title="高级设置" size="small" className="mt-4">
            <Alert
              ...
              description={
                <div className="text-sm space-y-1">
                  ...
                  <div>
                    <strong>最大步骤:</strong> 限制推理步骤数量，防止无限循环
                  </div>
                </div>
              }
              type="info"
            ...
            <Form.Item
              ...
              help="在问题前添加的自定义指令"
            >
              <TextArea rows={3} placeholder="例如：作为一个专业的分析师..." />
            </Form.Item>
          </Card>
        )}
      </Form>
