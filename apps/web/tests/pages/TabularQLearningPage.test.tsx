...
describe('TabularQLearningPage', () => {
  it('应该正确渲染页面标题和描述', () => {
    ...
    expect(screen.getByText('表格Q-Learning (Tabular Q-Learning)')).toBeInTheDocument();
  ...
  it('应该显示算法参数配置', () => {
    ...
    // 检查参数说明
    expect(screen.getByText('控制新信息对已有知识的影响程度')).toBeInTheDocument();
  ...
  it('应该显示算法特点和适用场景', () => {
    ...
    expect(screen.getByText('简单的游戏环境 (如Tic-Tac-Toe)')).toBeInTheDocument();
  });
