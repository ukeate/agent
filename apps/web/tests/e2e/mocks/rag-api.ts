    ...
    if (postData) {
      ...
      const streamEvents = [
        ...
        },
        {
          ...
          data: { step: 'expanded', expanded_queries: [`${data.query} 详细`, `${data.query} 相关`] }
        },
        {
          event: 'retrieval_start',
          data: { step: 'retrieving', agents: ['semantic', 'keyword', 'structured'] }
        },
        {
          event: 'retrieval_progress',
          data: { step: 'retrieving', progress: 0.5, current_agent: 'semantic' }
        },
        {
      ...
      const responseText = streamEvents
    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        explanation: {
          ...
          visualization_data: {
            retrieval_path: ['query', 'analysis', 'expansion', 'retrieval', 'validation'],
            agent_collaboration: {
    ...
    await route.fulfill({
      ...
      body: JSON.stringify({
        ...
        data: {
          ...
          agent_performance: {
            semantic_expert: { queries: 567, success_rate: 0.93, avg_time: 123 },
            keyword_expert: { queries: 423, success_rate: 0.89, avg_time: 98 },
            structured_expert: { queries: 257, success_rate: 0.87, avg_time: 156 }
          }
        }
      })
    })
